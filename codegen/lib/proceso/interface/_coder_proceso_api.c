 ...
 * Return Type  : void
 */
  void proceso_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                   *plhs[1])
{
  real_T (*xk1)[3];
  real_T (*u)[2];
  ...
  xk1 = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
...
/*
 * File trailer for _coder_proceso_api.c
 *
 * [EOF]
 */
